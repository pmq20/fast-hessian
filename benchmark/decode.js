...
// })
.add('Fast hessian2 decode: number', function() {
...
// })
.add('Fast hessian2 decode: date', function() {
...
// })
// .add('Fast hessian2 decode: long', function() {
...
// })
.add('Fast hessian2 decode: string', function() {
...
// // })
// .add('Fast hessian2 decode: simple object', function() {
...
// // })
// .add('Fast hessian2 decode with type: date', function() {
...
// // })
// .add('Fast hessian2 decode with type: long', function() {
...
// // })
// .add('Fast hessian2 decode with type: string', function() {
...
// // })
// .add('Fast hessian2 decode with type: simple object', function() {
...
// // })
// .add('Fast hessian2 decode with type: complex object', function() {
...
//  //  Fast hessian2 decode: number                   x 5,713,562 ops/sec ±2.22% (91 runs sampled)
//  //  hessian1 decode: date                     x 2,959,698 ops/sec ±1.19% (92 runs sampled)
//  //  Fast hessian2 decode: date                     x 2,548,345 ops/sec ±1.32% (91 runs sampled)
//  //  hessian1 decode: long                     x 3,880,734 ops/sec ±1.66% (93 runs sampled)
//  //  Fast hessian2 decode: long                     x 5,221,659 ops/sec ±2.30% (90 runs sampled)
//  //  hessian1 decode: string                   x 1,109,890 ops/sec ±1.59% (94 runs sampled)
//  //  Fast hessian2 decode: string                   x 1,075,246 ops/sec ±1.43% (92 runs sampled)
//  //  hessian1 decode: [1, 2, 3]                x 1,186,054 ops/sec ±1.24% (92 runs sampled)
//  //  Fast hessian2 decode: [1, 2, 3]                x 2,049,867 ops/sec ±1.75% (98 runs sampled)
//  //  hessian1 decode array                     x   511,250 ops/sec ±0.92% (95 runs sampled)
//  //  Fast hessian2 decode array                     x   600,564 ops/sec ±1.27% (90 runs sampled)
//  //  hessian1 decode: simple object            x   186,875 ops/sec ±0.81% (93 runs sampled)
//  //  Fast hessian2 decode: simple object            x   174,768 ops/sec ±0.74% (94 runs sampled)
//  //  hessian1 decode: complex object           x   133,573 ops/sec ±1.31% (97 runs sampled)
//  //  Fast hessian2 decode: complex object           x   131,234 ops/sec ±1.45% (95 runs sampled)
//  //  hessian1 decode with type: number         x 5,014,602 ops/sec ±1.97% (91 runs sampled)
//  //  Fast hessian2 decode with type: number         x 5,890,098 ops/sec ±1.81% (89 runs sampled)
//  //  hessian1 decode with type: date           x 2,797,789 ops/sec ±1.82% (91 runs sampled)
//  //  Fast hessian2 decode with type: date           x 2,541,107 ops/sec ±2.40% (92 runs sampled)
//  //  hessian1 decode with type: long           x 3,869,288 ops/sec ±1.31% (93 runs sampled)
//  //  Fast hessian2 decode with type: long           x 5,598,654 ops/sec ±1.20% (95 runs sampled)
//  //  hessian1 decode with type: string         x 1,068,879 ops/sec ±1.89% (92 runs sampled)
//  //  Fast hessian2 decode with type: string         x 1,110,680 ops/sec ±0.89% (94 runs sampled)
//  //  hessian1 decode with type: [1, 2, 3]      x 1,150,027 ops/sec ±0.94% (94 runs sampled)
//  //  Fast hessian2 decode with type: [1, 2, 3]      x 1,834,472 ops/sec ±0.90% (94 runs sampled)
//  //  hessian1 decode with type array           x   508,028 ops/sec ±0.99% (96 runs sampled)
//  //  Fast hessian2 decode with type array           x   605,446 ops/sec ±1.10% (96 runs sampled)
//  //  hessian1 decode with type: simple object  x   190,014 ops/sec ±0.92% (97 runs sampled)
//  //  Fast hessian2 decode with type: simple object  x   176,337 ops/sec ±1.16% (96 runs sampled)
//  //  hessian1 decode with type: complex object x   133,815 ops/sec ±1.21% (90 runs sampled)
//  //  Fast hessian2 decode with type: complex object x   134,814 ops/sec ±0.96% (96 runs sampled)
